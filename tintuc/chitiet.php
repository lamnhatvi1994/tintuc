...
<head>
    ...
    <title> Trang Chi Tiết Tin </title>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <!-- Date/Time -->
                <p><span class="glyphicon glyphicon-time"></span>Post on <?=$chiTietTin->created_at?></p>
                <hr>
				...
				<?php foreach($comment as $cmt){
					...
					<div class="media">
                        ...
                        <div class="media-body">
                            <h4 class="media-heading">Hiện tên người comment
