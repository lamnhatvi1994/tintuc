					...
					foreach ($tintuc as $tin){
                        ...
                        <div class="row-item row">
                            ...
                            <div class="col-md-9">
                                <h3><?=$tin->TieuDe?></h3>
                                <p><?=$tin->TomTat?></p>
                                <a class="btn btn-primary" href="chitiet.php?loai_tin=<?=$alias->TenKhongDau?>&id_tin=<?=$tin->id?>">Xem Chi Tiết <span class="glyphicon glyphicon-chevron-right"></span></a>
                            </div>
                            <div class="break"></div>
                        </div>
                        <?php
